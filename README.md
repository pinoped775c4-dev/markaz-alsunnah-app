...
### المشرف (معلم المتون والأوراد المخصص)
عند تعيين معلم "مشرف المتون والأوراد" من قبل الإدارة يتحول حسابه إلى
واجهة مشرف تعرض قسمين دائريتين:
- **المعلمون**: عرض كل المعلمين المسجلين من قبل الإدارة، والنقر على أي
  معلم يفتح حساب المعلم كاملاً (مستوياته: الدروس، المتون، القرآن) مع
  القدرة على إضافة الدروس والتسجيل فيها باسم ذلك المعلم.
- **الطلاب**: المتابعة المعتادة عبر المستويات التعليمية.

> ⚠️ هذه الصلاحية مشروطة بنشر قواعد `firestore.rules` المحدّثة عبر
> Firebase Console (المشرف يقرأ/يكتب بيانات كل المعلمين).
